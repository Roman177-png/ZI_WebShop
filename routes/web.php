...
Route::group(['prefix' => 'group'], function(){
    ...
    Route::get('/{product}/edit', \App\Http\Controllers\Group\EditController::class)->name('group.edit');
    Route::get('/{product}', \App\Http\Controllers\Group\ShowController::class)->name('group.show');
    Route::patch('/{product}', \App\Http\Controllers\Group\UpdateController::class)->name('group.update');
    Route::delete('/{product}', \App\Http\Controllers\Group\DeleteController::class)->name('group.delete');
});